...
This work is based on the AI Rainbows Coding Challenge by Daniel Shiffman.  He used the "rainbows" checkpoint in his video.  A lot more StyleGAN models have been added since the video was made (including some by Daniel--see below).  I decided to try out the SkyGAN model.
...
## You can create a free acount with RunwayML.  (There is a fee to upgrade to additional features.)
...
## Here is the Brownian snowflake model
